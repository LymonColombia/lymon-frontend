...
@Component({
  ...
  standalone: true,
  imports: [TenantPageLayoutComponent, FormsModule, NgIconComponent, ToastComponent, ShiftDatePickerComponent, TutorialHighlightDirective],
  providers: [
    provideIcons({
      bootstrapTrash,
      bootstrapPencil,
  ...
  templateUrl: './staff-shift.html',
  styleUrl: './staff-shift.css',
