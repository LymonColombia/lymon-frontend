...
import { UpdatePropertyUseCase } from '@/domain/shared/property/use-cases/update-property.use-case';
import { DeletePropertyUseCase } from '@/domain/shared/property/use-cases/delete-property.use-case';
import { GetPropertyByIdUseCase } from '@/domain/shared/property/use-cases/get-property-by-id.use-case';
import { TutorialService } from '@/presentation/tenant/services/tutorial.service';
import { CancellationPolicy, PropertyDetail, PropertyType, UpdatePropertyDto, Property } from '@/domain/shared/property/property.model';
