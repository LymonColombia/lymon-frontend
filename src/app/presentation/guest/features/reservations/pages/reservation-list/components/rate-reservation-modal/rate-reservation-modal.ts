...
import { CreateUnitRatingUseCase } from '@/domain/guest/guest-reservation/use-cases/create-unit-rating.use-case';
...
@Component({
  ...
  templateUrl: './rate-reservation-modal.html',
  styleUrl: './rate-reservation-modal.css',
