...
import type { Reservation } from '@/domain/shared/reservation/reservation.model';
import type { CreateReservationInput } from '@/domain/shared/reservation/use-cases/create-reservation.use-case';
import type { UpdateReservationInput } from '@/domain/shared/reservation/use-cases/update-reservation.use-case';
