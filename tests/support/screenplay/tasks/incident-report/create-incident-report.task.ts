...
export const openIncidentReportPage = (): ActorTask => async (actor: GuestActor) => {
  await actor.browse.page.goto('/incident-report/list');
};

/** Open the "Nueva Novedad" creation form */
export const openCreateIncidentReportForm = (): ActorTask => async (actor: GuestActor) => {
...
export const submitIncidentReportForm = (): ActorTask => async (actor: GuestActor) => {
